...
export default function CategoryAdd() {
  ...
  const validateForm = (): boolean => {
    ...
    setErrors(newErrors);
    return (
      !newErrors.categoryName && Object.keys(newErrors.attributes).length === 0
    );
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "/Product/POST/CreateNewCategory",
        categoryData
      );
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground-500">
                    Dettagli principali della categoria
                  </p>
                </div>
              </div>
            </CardHeader>
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground-500">
                      Definisci i campi personalizzati per questa categoria
                    </p>
                  </div>
                </div>
                <Button
              ...
              {attributes.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-foreground-500 mb-4">
                    Aggiungi attributi personalizzati per rendere più specifica
                    questa categoria
                  </p>
                  <Button
                    color="primary"
                          ...
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-8 h-8 rounded-lg flex items-center justify-center bg-${
                                getAttributeTypeInfo(attr.type).color
                              }/10`}
                            >
                              <Icon
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <Icon
                    ...
                    className={
                      categoryName.trim() ? "text-success" : "text-warning"
                    }
                  />
            ...
            <CardBody className="space-y-3">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground-500">
                    Usa nomi chiari e specifici per gli attributi
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground-500">
                    Scegli il tipo di dato più adatto per ogni attributo
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground-500">
                    Marca come obbligatori solo i campi essenziali
                  </p>
                </div>
              </div>
            </CardBody>
            ...
            <CardBody className="space-y-3">
              {attributeTypes.map((type) => (
                <div key={type.value} className="flex items-center gap-3">
                  <div
                    className={`w-8 h-8 rounded-lg flex items-center justify-center bg-${type.color}/10`}
                  >
                    <Icon
                      icon={type.icon}
                      className={`text-${type.color} text-sm`}
                    />
                  </div>
                  <div>
            ...
            <ModalHeader className="flex flex-col gap-1">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground-500">
                    Come apparirà la tua categoria
                  </p>
                </div>
              </div>
            </ModalHeader>
