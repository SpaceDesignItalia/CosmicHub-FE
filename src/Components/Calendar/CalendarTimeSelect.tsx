...
import {DurationEnum, type TimeSlot} from "./calendar-utils";
import {TimeFormatEnum, timeFormats} from "./calendar-utils";
...
export default function CalendarTimeSelect({
  ...
  const [timeFormat, setTimeFormat] = useState<TimeFormatEnum>(TimeFormatEnum.TwentyFourHour);
